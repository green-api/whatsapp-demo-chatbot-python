...
def option_2(notification: Notification) -> None:
    try:
        ...
        url_file: str = "https://storage.yandexcloud.net/sw-prod-03-test/ChatBot/corgi.pdf"
...
def option_3(notification: Notification) -> None:
    try:
        ...
        if not user:
            return message_handler(notification)
        url_file: str = "https://storage.yandexcloud.net/sw-prod-03-test/ChatBot/corgi.jpg"
...
def option_4(notification: Notification) -> None:
    try:
        ...
        url_file: str = "https://storage.yandexcloud.net/sw-prod-03-test/ChatBot/Audio_bot_eng.mp3"

        if user.language in ["kz", "ru"]:
            url_file = "https://storage.yandexcloud.net/sw-prod-03-test/ChatBot/Audio_bot.mp3"
...
def option_5(notification: Notification) -> None:
    try:
        ...
        url_file: str
        if user.language in ("kz", "ru"):
            url_file = "https://storage.yandexcloud.net/sw-prod-03-test/ChatBot/Video_bot_ru.mp4"
        else:
            url_file = "https://storage.yandexcloud.net/sw-prod-03-test/ChatBot/Video_bot_eng.mp4"
